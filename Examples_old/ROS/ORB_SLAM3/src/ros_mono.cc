...
int main(int argc, char **argv)
{
    ...
    ros::Subscriber sub = nodeHandler.subscribe("/zed/zed_node/left_raw/image_raw_color", 100, &ImageGrabber::GrabImage,&igb);
...
void ImageGrabber::GrabCompressedImage(const sensor_msgs::CompressedImageConstPtr &msg)
{
    ...
    mpSLAM->TrackMonocular(cv_ptr_compressed->image,cv_ptr_compressed->header.stamp.toSec());
}
