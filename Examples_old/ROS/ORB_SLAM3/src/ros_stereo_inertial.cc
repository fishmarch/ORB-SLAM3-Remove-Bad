...
int main(int argc, char **argv) {
    ...
    ros::Subscriber sub_imu = n.subscribe("/zed/zed_node/imu/data_raw", 1000, &ImuGrabber::GrabImu, &imugb);
    ros::Subscriber sub_img_left = n.subscribe("/zed/zed_node/left_raw/image_raw_color", 100, &ImageGrabber::GrabImageLeft, &igb);
    ros::Subscriber sub_img_right = n.subscribe("/zed/zed_node/right_raw/image_raw_color", 100, &ImageGrabber::GrabImageRight, &igb);
