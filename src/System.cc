...
//
//    list<shared_ptr<KeyFrame> > mlpReferences = mpTracker->GetReferences();
//    for(auto pKFi : mlpReferences){
//        cout << "ref: " << pKFi->mnId << " ";
//    }
//    cout << endl;
...
void System::SaveTrajectoryTUM(const string &filename)
{
    ...
    list<shared_ptr<KeyFrame> > mlpReferences = mpTracker->GetReferences();
    list<Sophus::SE3f> mlRelativeFramePoses = mpTracker->GetRelativeFramePoses();
...
void System::SaveTrajectoryEuRoC(const string &filename)
{
    ...
    for(Map* pMap :vpMaps)
    {
        ...
        std::cout << "  Map " << std::to_string(pMap->GetId()) << " has " << std::to_string(pMap->GetAllMapPoints().size()) << " MPs" << std::endl;
...
//        {
            ...
            Eigen::Quaternionf q = Twc.unit_quaternion();
            Eigen::Vector3f twc = Twc.translation();
            f << setprecision(6) << (*lT)*1e9 << " " <<  setprecision(9) << twc(0) << " " << twc(1) << " " << twc(2) << " " << q.x() << " " << q.y() << " " << q.z() << " " << q.w() << endl;
//        }
