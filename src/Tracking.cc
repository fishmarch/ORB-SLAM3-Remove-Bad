...
//    pCurrentMap->DeleteBadMapPoints();
...
void Tracking::StereoInitialization()
{
    if(mCurrentFrame.N>500)
    {
        ...
        // Create KeyFrame
        shared_ptr<KeyFrame>  pKFini = make_shared<KeyFrame>(mCurrentFrame,mpAtlas->GetCurrentMap(),mpKeyFrameDB, this);
...
{
    // Create KeyFrames
    shared_ptr<KeyFrame>  pKFini = make_shared<KeyFrame>(mInitialFrame,mpAtlas->GetCurrentMap(),mpKeyFrameDB, this);
    shared_ptr<KeyFrame>  pKFcur = make_shared<KeyFrame>(mCurrentFrame,mpAtlas->GetCurrentMap(),mpKeyFrameDB, this);
...
void Tracking::CreateNewKeyFrame()
{
    ...
    if(!mpLocalMapper->SetNotStop(true))
        return;
    shared_ptr<KeyFrame>  pKF = make_shared<KeyFrame>(mCurrentFrame,mpAtlas->GetCurrentMap(),mpKeyFrameDB, this);
